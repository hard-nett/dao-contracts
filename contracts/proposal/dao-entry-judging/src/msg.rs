...
use dao_voting::{
    entry_judging::{EntryJudgingOptions, EntryJudgingVote, VotingStrategy},
...
pub struct InstantiateMsg {
    ...
    pub only_admins_propose: bool,

    pub set_max_proposals_per_dao_member: MaxProposalsPerDaoMember,
...
pub enum ExecuteMsg {
    ...
    Close {
     ...
     UpdateConfig {
        ...
        set_max_proposals_per_dao_member: MaxProposalsPerDaoMember,
        allow_proposal_edit: bool,
        min_voting_element_range:
        max_voting_element_range:
        allow_revoting: bool,
        dao: String,
