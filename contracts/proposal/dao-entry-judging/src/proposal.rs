...
use dao_voting::{
    entry_judging::{
        CheckedEntryJudgingOption, EntryJudgingOptionType, EntryJudgingVotes, VotingStrategy,
    },
    status::Status,
...
pub struct EntryJudgingProposal {
    pub title: String,
    ...
    pub expiration: Expiration,
        ...
        pub choices: Vec<CheckedEntryJudgingOption>,
...
pub enum VoteResult {
    SingleWinner(CheckedEntryJudgingOption),
}

impl EntryJudgingProposal {
        ...
        if does_vote_count_pass(
            ...
            match vote_result {
                ...
                VoteResult::SingleWinner(winning_choice) => {
                    ...
                    if winning_choice.option_type != EntryJudgingOptionType::None {
    ...
    fn is_choice_unbeatable(
        &self,
        winning_choice: &CheckedEntryJudgingOption,
    ) -> StdResult<bool> {
