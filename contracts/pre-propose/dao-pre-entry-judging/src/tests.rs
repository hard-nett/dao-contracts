...
use dao_voting::{
    ...
    multiple_choice::{
        CheckedEntryJudgingOption, EntryJudgingOption, EntryJudgingOptionType,
        EntryJudgingOptions, EntryJudgingVote, VotingStrategy,
    },
...
fn cw_dao_entry_judging_contract() -> Box<dyn Contract<Empty>> {
...
fn setup_default_test(
    ...
    let cpm_id = app.store_code(cw_dao_entry_judging_contract());
...
fn make_proposal(
    ...
    assert_eq!(
        ...
        vec![
            CheckedEntryJudgingOption {
                description: "multiple choice option 1".to_string(),
                msgs: vec![],
                option_type: EntryJudgingOptionType::Standard,
            ...
            CheckedEntryJudgingOption {
                ...
                msgs: vec![],
                option_type: EntryJudgingOptionType::None,
                vote_count: Uint128::zero(),
                index: 2,
...
fn test_native_permutation(
    ...
    let (position, expected_status, trigger_refund): (
        ...
        EndStatus::Passed => (
            EntryJudgingVote { option_id: 0 },
            Status::Passed,
            execute_proposal,
        ),
        EndStatus::Failed => (
            EntryJudgingVote { option_id: 2 },
            Status::Rejected,
            close_proposal,
        ),
    };
        ...
        .execute_contract(
            ...
            &ExecuteMsg::Propose {
                msg: ProposeMessage::Propose {
                    ...
                    choices: EntryJudgingOptions {
                        options: vec![EntryJudgingOption {
                            description: "multiple choice option 1".to_string(),
                            msgs: vec![],
                            title: "title".to_string(),
                        }],
